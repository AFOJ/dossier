...
const GENERIC_MESSAGE = "We encountered an unexpected error while rendering this page."
...
describe("ErrorBoundary", () => {
  ...
  it("uses the response statusText and body as the heading and subheading", async () => {
    ...
    expect(screen.getByText("That resume does not exist anymore.")).toBeInTheDocument()
  })
  ...
  it("shows the router-generated 404 statusText and message when no route matches", async () => {
    ...
    expect(screen.getByText(/No route matches URL "\/does-not-exist"/)).toBeInTheDocument()
  })
})
