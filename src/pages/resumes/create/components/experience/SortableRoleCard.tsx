...
export function SortableRoleCard(props: Readonly<SortableRoleCardProps>) {
  ...
  const [bodyId] = useState(() => `role-body-${crypto.randomUUID()}`)
      ...
      <div className="flex items-center gap-2 p-3 pb-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button
            ...
            aria-label={`${isOpen ? "Collapse" : "Expand"} ${label} role`}
