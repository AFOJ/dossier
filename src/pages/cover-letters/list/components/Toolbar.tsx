...
export function Toolbar(props: Readonly<ToolbarProps>) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      />
      <ButtonLink intent="secondary" icon={FileAddIcon} to="/cover-letters/create">
        New cover letter
      </ButtonLink>
      <Tooltip
        content={
          isDisabled
            ? "Select cover letters to export"
            : isBulkExporting
              ? "Exporting..."
              : "Export selected"
        }
      ...
      <Tooltip content={isDisabled ? "Select cover letters to delete" : "Delete selected"}>
        <span className="inline-block">
          <Button
